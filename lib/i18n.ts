...
export const translations = {
  en: {
    nav: {
      ...
      reviews: "Reviews",
      contact: "Contact",
      book: "Book Your Slot Now",
      call: "Call Now",
    },
    hero: {
      badge: "Trusted by 5,000+ Patients in Chennai",
      title: "Pain-Free Dental Care",
      titleHighlight: "You Can Trust",
      subtitle:
        "Trusted by 5,000+ patients in Chennai. We make dental visits comfortable, stress-free, and completely painless — because your smile deserves the best.",
      bookCta: "Book Your Slot Now",
      callCta: "Call Now",
      stat1: "5,000+",
    ...
    footer: {
      tagline: "Advanced Dental Care You Can Trust.",
  ...
  ta: {
    ...
    hero: {
      badge: "சென்னையில் 5,000+ நோயாளிகளின் நம்பகம்",
      title: "வலியற்ற பல் சிகிச்சை",
      titleHighlight: "நம்பகமான கவனிப்பு",
      subtitle:
        "சென்னையில் 5,000+ நோயாளிகள் நம்பும் மருத்துவமனை. வலியற்ற, அமைதியான சிகிச்சை — உங்கள் புன்னகை எங்கள் முன்னுரிமை.",
    ...
    footer: {
      tagline: "நம்பகமான உன்னதமான பல் சிகிச்சை.",
